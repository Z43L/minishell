...
/*   Updated: 2025/07/23 15:39:17 by aamaya-g         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
typedef enum e_type
{
	...
	FILE_PATH,
	LIMITER,
	D_QUOTES, //comillas dobles
	S_QUOTES //comillas simples
}	t_type;
...
typedef struct s_cmd
{
	...
	char		**cmd_argv;
	char		**env;
	t_builtin	is_bi; //indica si es builtin
}	t_cmd;
...
typedef struct s_shell
{
	...
	char	**path;
	int		count;
	int 	save_stdin; // save usado en la funcion exec_one_bi
	int		save_stdout; // save usado en la funcion exec_one_bi
}	t_shell;
